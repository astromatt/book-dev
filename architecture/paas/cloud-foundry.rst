...
.. code-block:: console
    :caption: Rozwiązanie dla CF Dev
...
.. code-block:: console
    :caption: Rozwiązanie deploymentu lokalnego - uruchomienie
...
.. code-block:: console
    :caption: Rozwiązanie deploymentu lokalnego - baza danych
...
.. code-block:: console
    :caption: Rozwiązanie deploymentu cloud - kod
...
.. code-block:: console
    :caption: Rozwiązanie deploymentu cloud - baza danych
...
.. code-block:: console
    :caption: Rozwiązanie deploymentu cloud - skalowanie
